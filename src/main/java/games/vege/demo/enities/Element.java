...
/**
 * Class that represents either a vegetable or a fruit
 * Retrieves properties from 'items' package based on the number randomly generated by class ShuffleMachine
 */
